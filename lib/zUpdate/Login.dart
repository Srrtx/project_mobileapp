import 'dart:async';
import 'dart:convert';
import 'package:application/APPROVER/Home_approver.dart';
import 'package:application/HOME/Register.dart';
import 'package:application/STAFF/Home_staff.dart';
import 'package:application/USER(Student)/Home_user.dart';
...
class _LoginPageState extends State<LoginPage> {
  final Uri _uri = Uri.parse('http://192.168.137.1:3000/login');
  String _message = '';
